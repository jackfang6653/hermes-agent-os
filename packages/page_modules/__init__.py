...
六模块系统 (A-F):
  ...
  终极版块 G: brand_fullcase — 品牌全案溯源系统
    4调研(M1市场/M2用户/M3产品/M4竞品TOP10) + 因果溯源 + 7套交付物
...
# ── Module G: Brand FullCase — 终极版块 ──
from .brand_fullcase import (
    BrandFullCase,
    FullCaseResult,
    ModuleResult,
)
...
__all__ = [
    ...
    "DeliverablesGenerator",
    # G: Brand FullCase
    "BrandFullCase", "FullCaseResult", "ModuleResult",
]
